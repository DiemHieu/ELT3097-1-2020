...
public class MainActivity2Q1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main2_q1);
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(MainActivity2Q1.this, "Chọn đáp án!", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void openActivity3(){
        Intent intent = new Intent(this, MainActivity3Q1.class);
