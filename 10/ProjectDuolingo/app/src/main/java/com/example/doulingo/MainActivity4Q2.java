...
public class MainActivity4Q2 extends AppCompatActivity {
    EditText editText;
    Button btCheck;
    Button btContinue;
    ProgressBar pbNext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main4_q2);
        ...
        btContinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity4Q2.this, StartScreen.class);
